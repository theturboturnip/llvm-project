...
; CHECK-IR-NEXT:  entry:
; CHECK-IR-NEXT:    call void @llvm.memcpy.p200i8.p200i8.i32(i8 addrspace(200)* noundef nonnull align 4 dereferenceable(17) [[DST]], i8 addrspace(200)* noundef nonnull align 4 dereferenceable(17) getelementptr inbounds ([17 x i8], [17 x i8] addrspace(200)* @str, i32 0, i32 0), i32 17, i1 false) #[[ATTR0]]
